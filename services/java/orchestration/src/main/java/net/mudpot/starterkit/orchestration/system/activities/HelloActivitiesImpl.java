...
import net.mudpot.starterkit.persistence.history.PromptRunEntity;
...
public class HelloActivitiesImpl implements HelloActivities {
    ...
    public HelloWorldResult completeHello(
        ...
        entity.setUseCase(useCase == null || useCase.isBlank() ? "Demonstrate the StarterKit platform baseline." : useCase.trim());
